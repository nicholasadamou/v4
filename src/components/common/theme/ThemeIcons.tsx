...
// System/Monitor Icon
export const SystemIcon: React.FC<ThemeIconProps> = ({
  className = "h-4 w-4",
  width = 16,
  height = 16,
}) => (
...
// Light/Sun Icon
export const LightIcon: React.FC<ThemeIconProps> = ({
  className = "h-4 w-4",
  width = 16,
  height = 16,
}) => (
...
// Dark/Moon Icon
export const DarkIcon: React.FC<ThemeIconProps> = ({
  className = "h-4 w-4",
  width = 16,
  height = 16,
}) => (
...
export interface ThemeConfig {
  ...
  label: string;
  icon: React.ComponentType<ThemeIconProps>;
}
