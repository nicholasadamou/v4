...
const InlineEmbed: React.FC<InlineEmbedProps> = ({ id }) => {
  ...
  return (
    <Link
      ...
      className="not-prose flex items-center gap-3 rounded-lg border border-zinc-200 px-4 py-2.5 no-underline transition-colors hover:bg-zinc-100/50 dark:border-zinc-600 dark:hover:bg-zinc-800/50"
    >
      <YouTubeIcon />
